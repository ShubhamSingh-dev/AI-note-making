...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    function: {
      name: "update_note",
      description: "Updates an existing note. Only provide fields that need to change.",
      parameters: {
        type: "object",
        properties: {
          ...
          isCompleted: { type: "boolean", description: "Mark note as completed or not" },
        },
        required: ["noteId"],
      },
    },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          query: { type: "string", description: "Search term to look for in notes" },
        },
        required: ["query"],
      },
    },
